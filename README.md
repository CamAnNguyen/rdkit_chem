...
#### macOS
  * cmake
  * swig (4.x recommended)
  * boost (1.84+ recommended, custom static build may be needed)
  * freetype
  * eigen
  * Ruby 3.1.x (see Known Issues below)

Install via Homebrew:
```bash
brew install cmake swig boost freetype eigen
```
